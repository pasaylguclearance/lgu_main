...
if($mode=='contactForm'){
		...
		$mail->Subject = "Auto Parts_Tools Store Contact Us";
  ...
  <table border="0" cellspacing="0" cellpadding="5" width="800" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; border:1px solid #cccccc; border-collapse:collapse">
    ...
    <tr>
      ...
      <tr>
			<td colspan="2"><font face="Verdana" style="font-size:12px">'.ucwords($_REQUEST['name']).' has Contected Auto Parts_Tools Store .
</font></td>
	</tr>
          <tr>
...
if($mode=='subscriber'){
		...
		$mail->FromName = "Auto Parts_Tools Store ";			
		$mail->Subject = "Auto Parts_Tools Store Subscribe";
		$mail->AddAddress('contact@srgit.com',"Admin");
		//$mail->AddBCC("swalehap@srgit.com","Admin");
		$mail->Body = "";
		$mail->AltBody = "";
  ...
  <table border="0" cellspacing="0" cellpadding="5" width="800" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; border:1px solid #cccccc; border-collapse:collapse">
    ...
    <tr>
      ...
      <tr>
        ...
        <tr>
			<td colspan="2"><br />
			<font face="Verdana" style="font-size:12px" color="#666666"><b>From Auto Parts_Tools Store auto-email</b><br />
			</font>
			</td>
		</tr>
			</table></td>
...
if($mode=='comingsoon'){
		...
		$mail->FromName = "Auto Parts_Tools Store ";			
		$mail->Subject = "Auto Parts_Tools Store Coming Soon";
		$mail->AddAddress('contact@srgit.com',"Admin");
		//$mail->AddBCC("swalehap@srgit.com","Admin");
		$mail->Body = "";
		$mail->AltBody = "";
