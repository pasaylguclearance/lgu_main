                                                ...
                                                <div class="pc-sheet">
                                                    ...
                                                    <div class="pc-titlebar">
                                                        ...
                                                        <div class="pc-control">
                                                            ...
                                                            <span class="pc-control-no">{{ $selectedApplicant->ucid }}</span>
                                                            <span class="pc-control-dates"><b>Date Issued:</b> {{ $issuedAt->format('M d, Y') }} &nbsp;&middot;&nbsp; <b>Valid Until:</b> {{ $validUntil->format('M d, Y') }}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="pc-body">
                                                        <div class="pc-main">
                                                            ...
                                                            <div class="pc-name">
                                                                ...
                                                                <span class="pc-value">{{ $fullName }}</span>
                                                            </div>
                                                            <div class="pc-grid">
                                                                <div class="pc-field w4 pc-address">
                                                                    <span class="pc-label">Address</span>
                                                                    <span class="pc-value">{{ $certificateAddressText }}</span>
                                                                </div>
                                                                <div class="pc-field w2">
                                                                    <span class="pc-label">Date of Birth</span>
                                                                    <span class="pc-value">{{ \Carbon\Carbon::parse($selectedApplicant->birthdate)->format('d M Y') }}</span>
                                                                </div>
                                                                <div class="pc-field w2">
                                                                    <span class="pc-label">Place of Birth</span>
                                                                    <span class="pc-value">{{ $selectedApplicant->birth_place }}</span>
                                                                </div>
                                                                <div class="pc-field g1">
                                                                    <span class="pc-label">Gender</span>
                                                                    <span class="pc-value">{{ $selectedApplicant->gender }}</span>
                                                                </div>
                                                                <div class="pc-field g2">
                                                                    <span class="pc-label">Civil Status</span>
                                                                    <span class="pc-value">{{ $selectedApplicant->civil_status }}</span>
                                                                </div>
                                                                <div class="pc-field g3">
                                                                    <span class="pc-label">Citizenship</span>
                                                                    <span class="pc-value">{{ optional($selectedApplicant->nationality)->nationality }}</span>
                                                                </div>
                                                                <div class="pc-field g4">
                                                                    <span class="pc-label">Religion</span>
                                                                    <span class="pc-value">{{ optional($selectedApplicant->religion)->religion }}</span>
                                                                </div>
                                                                <div class="pc-field w4 pc-purpose">
                                                                    <span class="pc-label">Purpose</span>
                                                                    <span class="pc-value">{{ optional($selectedApplicant->purpose)->purpose }}</span>
                                                                    <p class="pc-note">(NOT VALID FOR ABROAD AND NATURALIZATION)</p>
                                                                </div>
                                                            </div>
                                                            <div class="pc-result">
                                                                <span class="pc-label">Remarks</span>
                                                                <span class="pc-value">{{ $displayDerogatoryRemarks }}</span>
                                                            </div>
                                                        ...
                                                        <div class="pc-side">
                                                            @if($hasPicture)
                                                                <div class="pc-photo" style="background-image:url('/img/application_picture/{{ $selectedApplicant->id }}/{{ $selectedApplicant->picture }}.png');"></div>
                                                            @else
                                                                <div class="pc-photo empty">No Image</div>
                                                            @endif
                                                            @if($hasSignature)
                                                                <div class="pc-sig" style="background-image:url('/img/signature/{{ $selectedApplicant->id }}/{{ rawurlencode($selectedApplicant->signature) }}');"></div>
                                                            @else
                                                                <div class="pc-sig empty">No Signature</div>
                                                            @endif
                                                    ...
                                                    <div class="pc-foot">
                                                        <div class="pc-foot-brand">
                                                            ...
                                                            <div class="pc-qr"><img src="https://api.qrserver.com/v1/create-qr-code/?size=90x90&data={{ rawurlencode($selectedApplicant->ucid) }}" alt="QR" style="width:78px;height:78px;"></div>
                                                        </div>
                                                        <div class="pc-meta">
                                                            <div><b>Encoder</b> {{ $loggedFirstName }}</div>
                                                            <div><b>Print By</b> {{ $loggedFirstName }}</div>
                                                            <div><b>Print Date</b> {{ now()->format('M d, Y') }}</div>
                                                            <div><b>OR Number</b> {{ $displayOrNo ?: '-' }}</div>
                                                            <div><b>Cedula Number</b> {{ $displayCedulaNo ?: '-' }}</div>
                                                            <div><b>Issued At</b> {{ $selectedApplicant->issued_at ?: '-' }}</div>
                                                            <div><b>Issued On</b> {{ $issuedDate }}</div>
                                                        </div>
                                                        <div class="pc-seal">
                                                            <div class="pc-seal-badge">Not Valid Without Dryseal</div>
                                                            <div class="pc-seal-amount"><b>OR Date / Total Amount:</b> {{ $issuedOrDate }} / P 250.00</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
